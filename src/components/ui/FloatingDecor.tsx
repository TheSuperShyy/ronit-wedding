...
type Props = {
  ...
  drift?: number;
  /** Opacity — purely decorative, keep low. */
  opacity?: number;
  /** Tint (defaults to soft ivory). */
  color?: string;
};
...
/** Slow floating decorative SVG. Static under reduced motion. */
export default function FloatingDecor({
  ...
  return (
    <motion.svg
      ...
      transition={reduced ? undefined : { duration, ease: 'easeInOut', repeat: Infinity, delay }}
    >
      {PATHS[shape]}
    </motion.svg>
  );
